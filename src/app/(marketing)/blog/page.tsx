...
export async function generateMetadata() {
    return {
        ...
        description: "Temukan wawasan segar seputar melon premium, tips budidaya, hingga manfaat kesehatan dari Agro Lestari.",
    };
}
        ...
        <div className="max-w-6xl mx-auto py-12 px-4 space-y-10">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-6 lg:grid-cols-8 auto-rows-[minmax(180px,auto)] gap-4">
                {sortedBlogs.map((blog, idx) => {
                    const colSpan =
                        idx === 0 ? "sm:col-span-3 lg:col-span-4" :
                            idx === 1 ? "sm:col-span-3 lg:col-span-2" :
                                idx === 2 ? "sm:col-span-3 lg:col-span-2" :
                                    idx === 3 ? "sm:col-span-6 lg:col-span-3" :
                                        idx === 4 ? "sm:col-span-3 lg:col-span-2" : "sm:col-span-3 lg:col-span-2";

                    const rowSpan =
                        idx === 0 ? "row-span-2" :
                            idx === 3 ? "row-span-2" : "row-span-1";
